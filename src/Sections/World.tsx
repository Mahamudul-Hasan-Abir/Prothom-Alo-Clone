...
import Trump from "../../public/assets/frontpageimages/trump.avif";
import Charge from "../../public/assets/frontpageimages/charge.avif";
import Resque from "../../public/assets/frontpageimages/resque.avif";
import Meat from "../../public/assets/frontpageimages/meat.avif";
import Artilary from "../../public/assets/frontpageimages/artilary.avif";
const World = () => {
  return (
    <div className="mt-20">
