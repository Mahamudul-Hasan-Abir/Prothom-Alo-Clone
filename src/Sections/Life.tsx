...
import Women4 from "../../public/assets/frontpageimages/women-4.avif";
import Daddy from "../../public/assets/frontpageimages/daddy.avif";
import Fish from "../../public/assets/frontpageimages/fish.avif";
import Banana from "../../public/assets/frontpageimages/banana.avif";
const Life = () => {
  return (
    <div className="mt-20">
